...
def to_credential(  # pylint: disable=R0913
    ...
    credential_values = {}
    #
    aws_access_key_id = configuration_data["aws_access_key_id"]
    #
    if aws_access_key_id is not None and aws_access_key_id and aws_access_key_id != "-":
        credential_values["aws_access_key_id"] = aws_access_key_id
    #
    aws_secret_access_key = configuration_data["aws_secret_access_key"]
    #
    if aws_secret_access_key is not None and aws_secret_access_key and aws_secret_access_key != "-":
        credential_values["aws_secret_access_key"] = aws_secret_access_key
    #
    aws_region_name = configuration_data["aws_region_name"]
    #
    if aws_region_name is not None and aws_region_name and aws_region_name != "-":
