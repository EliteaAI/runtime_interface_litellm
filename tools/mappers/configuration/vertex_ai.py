...
def to_credential(  # pylint: disable=R0913
    ...
    #
    vertex_project = configuration_data["vertex_project"]
    vertex_location = configuration_data["vertex_location"]
    vertex_credentials = configuration_data["vertex_credentials"]
    #
    credential_values = {
